...
import bannerImage from '../Corporate1.jpg'; // add a full-width banner image for the page
import articleImage1 from '../Bstructuring1.jpg';
import articleImage2 from '../Mergers1.jpg';
import articleImage3 from '../Gorvenance1.jpg';
...
const CorporatePage = () => {
  ...
  return (
    ...
    {[
        {
        title: 'Strategic Business Structuring & Incorporation',
        image: articleImage1,
        text: 'Our lawyers assist startups and international corporations with business setup, restructuring, and compliance. We guide clients through optimal legal structures, regulatory clearances, and tax-efficient models that align with long-term growth strategies.',
        },
        {
        title: 'Mergers, Acquisitions & Due Diligence',
        image: articleImage2,
        text: 'With experience across industries, we represent clients in mergers, acquisitions, and joint ventures. From legal due diligence to negotiating and drafting transaction documents, we provide practical, actionable advice that mitigates risk.',
        },
        {
        title: 'Corporate Governance & Regulatory Compliance',
        image: articleImage3,
        text: 'We help organizations stay aligned with national and international regulations. Our team advises on board governance, shareholder agreements, ESG policies, anti-corruption laws, and statutory reporting obligations.',
        },
    ].map((item, idx) => (
        ...
        <div className={`col-md-6 mt-4 mt-md-0 ${idx % 2 === 1 ? 'order-md-1' : ''}`}>
            <h4 className="fw-semibold mb-3" style={{ color: '#5c4033' }}>{item.title}</h4>
            <p style={{ lineHeight: '1.7', color: '#3e2f1c' }}>{item.text}</p>
            <a href="#" style={{ color: '#8B5E3C', fontWeight: 500, textDecoration: 'underline' }}>Learn more</a>
        </div>
        </div>
    ))}
    </section>

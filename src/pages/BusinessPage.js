...
import bannerImage from '../Business1.jpg'; // add a full-width banner image for the page
  ...
  return (
    <>
      ...
      <div style={{
        ...
        {/* Business Legalization Services */}
        <section style={{ padding: '4rem 5%', backgroundColor: '#fdf7f0' }}>
        ...
        <div className="row g-4">
            {[
            {
                ...
                description: 'We facilitate the authentication of corporate and personal documents from the Ministry of Foreign Affairs and embassies for international use.'
            },
            {
                icon: 'building',
            ...
            },
            {
                ...
                description: 'Protect your intellectual assets through proper registration, legal enforcement, and advisory on brand security.'
            },
            {
                icon: 'people-fill',
            ...
            <div className="col-md-6 col-lg-6" key={idx} data-aos="fade-up" data-aos-delay={idx * 100}>
                ...
                >
                <div className="mb-3">
                    <i className={`bi bi-${service.icon} fs-2 text-muted`}></i>
                </div>
                <h5 className="fw-semibold" style={{ color: '#5c4033' }}>{service.title}</h5>
                <p className="text-muted" style={{ lineHeight: '1.7' }}>{service.description}</p>
                </div>
            </div>
            ))}
        </div>
